...
import groupId.retailersv1.domain.CartAddUuBean;
import groupId.retailersv1.func.BeanToJsonStrMapFunction;
import groupId.retailersv1.stream.utils.DorisUtils;
...
/**
 * Title: DbusDwsTradeCartAddUuToDoris
 * Author: hyx
 * Package: groupId.retailersv1.dws
 * Date: 2025/8/23 10:43
 * Description: 交易域加购各窗口汇总表（5秒滚动窗口，按日去重用户）
 */
public class DbusDwsTradeCartAddUuToDoris {
       ...
       //jsonObjDS.print();
        ...
        SingleOutputStreamOperator<JSONObject> withWatermarkDS = jsonObjDS.assignTimestampsAndWatermarks(
                WatermarkStrategy
                        ...
                        .withTimestampAssigner((jsonObj, timestamp) -> {
                            if (jsonObj == null) {
                                return System.currentTimeMillis(); // 兜底时间
                            }
                            Long ts_ms = jsonObj.getLong("ts_ms");
                            return ts_ms != null ? ts_ms : System.currentTimeMillis();
                        })
        );
        ...
        SingleOutputStreamOperator<JSONObject> cartUUDS = keyedDS.process(
                new KeyedProcessFunction<String, JSONObject, JSONObject>() {
                    ...
                    public void processElement(JSONObject jsonObj, KeyedProcessFunction<String, JSONObject, JSONObject>.Context ctx, Collector<JSONObject> out) throws Exception {
                        ...
                        //获取当前这次加购日期
                        Long ts_ms = jsonObj.getLong("ts_ms") ;
                        String curCartDate = DateTimeUtils.tsToDate(ts_ms);
...
//TODO 6.聚合
        ...
        aggregateDS.print();
        aggregateDS.map(new BeanToJsonStrMapFunction<CartAddUuBean>()).sinkTo(DorisUtils.getDorisSink("dws_trade_cart_add_uu_window"));
