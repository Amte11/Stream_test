...
--② 每日装载
insert overwrite table dws_interaction_sku_favor_add_1d partition(dt='2025-07-04')
select
    sku_id,
    sku_name,
    category1_id,
...
--② 每日装载
insert overwrite table dws_tool_user_coupon_coupon_used_1d partition(dt='2025-07-04')
select
    user_id,
    coupon_id,
    coupon_name,
...
--② 每日装载
insert overwrite table dws_trade_province_order_1d partition(dt='2025-07-04')
select
    province_id,
    province_name,
    area_code,
...
insert overwrite table dws_trade_province_order_nd partition(dt='2025-07-03')
select
    province_id,
    province_name,
    area_code,
    iso_code,
    iso_3166_2,
    sum(if(dt>=date_add('2025-07-03',-6),order_count_1d,0)),
    sum(if(dt>=date_add('2025-07-03',-6),order_original_amount_1d,0)),
    sum(if(dt>=date_add('2025-07-03',-6),activity_reduce_amount_1d,0)),
    sum(if(dt>=date_add('2025-07-03',-6),coupon_reduce_amount_1d,0)),
    sum(if(dt>=date_add('2025-07-03',-6),order_total_amount_1d,0)),
    sum(order_count_1d),
...
where dt>=date_add('2025-07-03',-29)
  and dt<='2025-07-03'
...
insert overwrite table dws_trade_user_cart_add_1d partition(dt='2025-07-04')
select
    user_id,
    count(*),
    sum(sku_num)
...
insert overwrite table dws_trade_user_order_1d partition(dt='2025-07-04')
select
    user_id,
    count(distinct(order_id)),
    sum(sku_num),
...
insert overwrite table dws_trade_user_order_td partition(dt='2025-07-03')
select
    user_id,
...
insert overwrite table dws_trade_user_order_td partition (dt = '2025-07-04')
select nvl(old.user_id, new.user_id),
       if(old.user_id is not null, old.order_date_first, '2025-07-04'),
       if(new.user_id is not null, '2025-07-04', old.order_date_last),
...
from (
         ...
         where dt = date_add('2025-07-04', -1)
     ) old
         full outer join
     (
         select user_id,
...
from (
         ...
         union all
         select user_id,
                '2025-07-04' order_date_first,
                '2025-07-04' order_date_last,
                order_count_1d,
                order_num_1d,
                order_original_amount_1d,
                activity_reduce_amount_1d,
...
group by user_id,dt;
--② 每日装载
insert overwrite table dws_trade_user_payment_1d partition(dt='2025-07-04')
select
    user_id,
    count(distinct(order_id)),
    sum(sku_num),
...
set hive.vectorized.execution.enabled = false;
insert overwrite table dws_trade_user_sku_order_1d partition(dt='2025-07-03')
select
    user_id,
    id,
    sku_name,
...
insert overwrite table dws_trade_user_sku_order_nd partition(dt='2025-07-03')
select
    user_id,
    sku_id,
    sku_name,
    ...
    tm_name,
    sum(if(dt>=date_add('2025-07-03',-6),order_count_1d,0)),
    sum(if(dt>=date_add('2025-07-03',-6),order_num_1d,0)),
    sum(if(dt>=date_add('2025-07-03',-6),order_original_amount_1d,0)),
    sum(if(dt>=date_add('2025-07-03',-6),activity_reduce_amount_1d,0)),
    sum(if(dt>=date_add('2025-07-03',-6),coupon_reduce_amount_1d,0)),
    sum(if(dt>=date_add('2025-07-03',-6),order_total_amount_1d,0)),
...
insert overwrite table dws_traffic_page_visitor_page_view_1d partition(dt='2025-07-03')
select
    mid_id,
    brand,
    model,
...
insert overwrite table dws_traffic_session_page_view_1d partition(dt='2025-07-03')
select
    session_id,
    mid_id,
    brand,
...
insert overwrite table dws_user_user_login_td partition (dt = '2025-07-03')
select u.id                                                         user_id,
...
select nvl(old.user_id, new.user_id)                                        user_id,
       if(new.user_id is null, old.login_date_last, '2025-07-04')           login_date_last,
       if(old.login_date_first is null, '2025-07-04', old.login_date_first) login_date_first,
