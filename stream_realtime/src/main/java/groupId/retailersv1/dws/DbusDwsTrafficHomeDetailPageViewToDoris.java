...
import com.utils.*;
import groupId.retailersv1.domain.TrafficHomeDetailPageViewBean;
...
/**
 * Title: DbusDwsTrafficHomeDetailPageViewToDoris
 * Author: hyx
 * Package: groupId.retailersv1.dws
 * Date: 2025/8/22 21:39
 * Description: 流量域首页、详情页页面浏览各窗口汇总表
 */
public class DbusDwsTrafficHomeDetailPageViewToDoris {
